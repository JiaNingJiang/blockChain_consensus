...
func TestV3_PBKDF2_1(t *testing.T) {
	tests := loadKeyStoreTestV3("../../tmp/tests/KeyStoreTests/v3_test_vector.json", t)
	testDecryptV3(tests["wikipage_test_vector_pbkdf2"], t)
}

func TestV3_PBKDF2_2(t *testing.T) {
	tests := loadKeyStoreTestV3("../../tmp/tests/KeyStoreTests/basic_tests.json", t)
...
func TestV1_1(t *testing.T) {
	tests := loadKeyStoreTestV1("../../tmp/tests/KeyStoreTests/v1_test_vector.json", t)
	testDecryptV1(tests["test1"], t)
}

func TestV1_2(t *testing.T) {
	ks := NewKeyStorePassphrase("../../tmp/tests/KeyStoreTests/v1")
